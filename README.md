# streempilot-test/upgrade-compatibility-tests
...
This repository is the `upgrade` deep-test suite for `streempilot`. It is intentionally dependency-light and deterministic so failures can be reproduced locally without production credentials or customer data.
